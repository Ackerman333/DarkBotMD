...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/fd6de9e0929bf215f632c.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 5k per Group Permanen\n\nPayment  via DANA atau PULSA\n\nLebih detail bisa hubungi owner\nhttps://wa.me/6282275576880 (Owner)` }, { quoted: m })
            }
            break
            case 'sc': {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                ...
                                urlButton: {
                                    displayText: 'Group',
                                    phoneNumber: 'https://chat.whatsapp.com/Fd92L258maQ6lWjIua6Djq'
                                }
                            }, {
                                quickReplyButton: {
